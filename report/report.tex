...
\begin{figure}[phtbp]
  ...
  \begin{subfigure}[b]{0.49\textwidth}
    ...
    \caption{Average---Standard Deviation\label{fig:Cavgstd}}
  \end{subfigure}
...
To benchmark above results I used static clustering on data repository created by one run of program. The algorithms are: ..., and ... implemented in \texttt{WEKA} machine learning package. The choice the algorithms is motivated by no need of fixing ``number of clusters'' parameter.\\
