...
\begin{description}
  ...
  \item[lag-$n$] is a difference between current value of signal and n\ts{th} previous value i.e.\ $v_t - v_{t-n}$,
...
Affinity Propagation is state-of-the-art clustering solution based on message passing between points. The algorithm finds centroids i.e.\ the heart of .\\
...
\citep{zhang2013data} introduced adaptation of Affinity Propagation algorithm to streams of data. The overview of the approach is presented in \emph{Figure}~\ref{fig:APC}.\\
